      ...
      try {
        ...
        if (orderCode || transactionCode) {
          ...
          try {
            ...
            console.warn(
              "Webhook call failed, but payment might still be successful:",
              webhookError
            );
        ...
        <div className="success-section">
          ...
          <div className="success-header">
            ...
            <p className="success-subtitle">
              Giao dịch của bạn đã được xử lý hoàn tất
            </p>
          </div>
          ...
          <div className="success-message">
            <div className="message-content">
              <h4>Chúc mừng bạn!</h4>
              <p>
                Thanh toán đã được xử lý thành công và bạn sẽ nhận được email
                xác nhận trong vài phút tới.
              </p>
            </div>
          </div>
