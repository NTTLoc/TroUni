    ...
    <div style={{ padding: '20px', maxWidth: '600px', margin: '0 auto' }}>
        ...
        <Space direction="vertical" style={{ width: '100%' }}>
          ...
          {result && (
            <Alert
              ...
              description={
                <div>
                  <div><strong>Display Name:</strong> {result.display_name}</div>
                  <div><strong>Address:</strong> {JSON.stringify(result.address, null, 2)}</div>
                  <div><strong>Raw Data:</strong> {JSON.stringify(result.raw_data, null, 2)}</div>
                </div>
              }
              type="success"
              showIcon
      ...
      <Card title="📍 Test Coordinates" style={{ marginTop: '20px' }}>
        <Space direction="vertical">
          <div><Text strong>TP.HCM Center:</Text> 10.8231, 106.6297</div>
          <div><Text strong>Quận 1:</Text> 10.7769, 106.7009</div>
          <div><Text strong>Quận 3:</Text> 10.7829, 106.6879</div>
          <div><Text strong>Quận 7:</Text> 10.7377, 106.7225</div>
        </Space>
      </Card>
    </div>
  );
